...
function sniffBytes(b: Uint8Array): string | null {
    ...
    if (b.length >= 8 && at(0) === 0x89 && at(1) === 0x50 && at(2) === 0x4e && at(3) === 0x47) return "PNG image";
    if (b.length >= 3 && at(0) === 0xff && at(1) === 0xd8 && at(2) === 0xff) return "JPEG image";
    if (b.length >= 4 && at(0) === 0x47 && at(1) === 0x49 && at(2) === 0x46 && at(3) === 0x38) return "GIF image";
    if (b.length >= 4 && at(0) === 0x25 && at(1) === 0x50 && at(2) === 0x44 && at(3) === 0x46) return "PDF document";
    if (
        b.length >= 12 &&
        at(0) === 0x52 && at(1) === 0x49 && at(2) === 0x46 && at(3) === 0x46 &&
        at(8) === 0x57 && at(9) === 0x45 && at(10) === 0x42 && at(11) === 0x50
    ) return "WebP image";
    if (b.length >= 4 && at(0) === 0x50 && at(1) === 0x4b && at(2) === 0x03 && at(3) === 0x04) return "ZIP archive";
...
export function decodeText(input: string, opts: Base64Options): Base64Result {
    ...
    const output = binary ? `[binary content — ${bytes.length.toLocaleString()} bytes]` : (decodedText as string);
